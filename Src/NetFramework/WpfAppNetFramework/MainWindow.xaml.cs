...
namespace WpfAppNetFramework
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            add_addressTextBox.Text = string.Empty;
            add_cityTextBox.Text = string.Empty;
            add_companyNameTextBox.Text = string.Empty;
            add_contactNameTextBox.Text = string.Empty;
            add_contactTitleTextBox.Text = string.Empty;
            add_countryTextBox.Text = string.Empty;
            add_customerIDTextBox.Text = string.Empty;
            add_faxTextBox.Text = string.Empty;
            add_phoneTextBox.Text = string.Empty;
            add_postalCodeTextBox.Text = string.Empty;
            add_regionTextBox.Text = string.Empty;
